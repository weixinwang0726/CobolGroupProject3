      ...
      *DESCRIPTION:      
      *THIS PROGRAM READS STUDENT RECORDS AND COURSE RECORDS FROM 
      *EXTERNALE FILES STUFILE_IN.TXT AND PROGRAM.TXT, CALCULATE THE    
      ...
      *REPORT COLUNM HEADING 
       ...
       01  AUDIT-TRAIL.
           ...
           05 READING-COUNTER-OUT  PIC ZZ9     VALUE ZERO.
           05 FILLER               PIC X(25)   VALUE SPACES.
           05 FILLER               PIC X(16)   VALUE "RECORDS WRITTEN:".
           05 WRITING-COUNTER-OUT  PIC ZZ9     VALUE ZERO.    
      ...
      *CREATE THE STUDENT REPORT 
       ...
       201-INITIATE-CREATE-STUDENT-REPORT.
           ...
           PERFORM 304-WRITE-REPORT-COLUMN-HEADERS. 
           PERFORM 305-READ-STUDENT-PROGRAM-RECORDS.
        
       202-CREATE-STUDEN-REPORT-RECORD.
           PERFORM 306-CALCULATE-STUDENT-AVERAGE. 
       ...
       308-DISPLAY-RECORD-COUNTERS.
           MOVE RECORDS-IN-COUNTER-WS TO READING-COUNTER-OUT.           
           MOVE RECORDS-OUT-COUNTER-WS TO WRITING-COUNTER-OUT.          
           WRITE STUDENT-REPORT-RECORD-OUT FROM AUDIT-TRAIL
